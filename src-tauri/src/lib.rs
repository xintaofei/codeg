...
mod tauri_app {
    ...
    use crate::commands::{
        ...
        folders, loops as loops_commands, mcp as mcp_commands,
    ...
    pub fn run() {
        ...
        builder
            ...
            .invoke_handler(tauri::generate_handler![
                ...
                loops_commands::create_loop_issue,
                loops_commands::delete_loop_issue,
                loops_commands::update_loop_issue_config,
                loops_commands::trigger_loop_issue,
                loops_commands::pause_loop_issue,
                loops_commands::resume_loop_issue,
                loops_commands::cancel_loop_issue,
                loops_commands::retry_loop_issue,
                loops_commands::force_complete_loop_task,
                loops_commands::override_loop_oscillation,
                loops_commands::add_loop_issue_budget,
                ...
                loops_commands::get_loop_artifact_iterations,
                loops_commands::get_loop_phase_iterations,
                loops_commands::list_loop_validations,
                loops_commands::list_loop_inbox,
                loops_commands::get_loop_attention,
                loops_commands::dismiss_loop_inbox,
                loops_commands::list_loop_memory,
                loops_commands::create_loop_memory,
                loops_commands::update_loop_memory,
                loops_commands::delete_loop_memory,
