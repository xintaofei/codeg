...
pub enum BrokerMessage {
    ...
    ContinueWithSession(BrokerContinueWithSessionRequest),
    GetSessionTurnStatus(BrokerGetSessionTurnStatusRequest),
    CancelSessionTurn(BrokerCancelSessionTurnRequest),
