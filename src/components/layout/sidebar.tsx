...
export function Sidebar() {
  ...
  // `showSubsessions` defaults OFF (delegation children only expand when the
  // user opts in via the funnel menu). The mount effect below reconciles a
  // persisted override. Each initial value matches its own default so the
